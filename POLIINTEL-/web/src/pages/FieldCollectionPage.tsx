            ...
            <Card key={assignment.id}>
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  <Badge variant={
                    assignment.territory_level === 'barrio'            ? 'warning' :
                    assignment.territory_level === 'seccion'           ? 'info'    :
                    assignment.territory_level === 'distrito_municipal' ? 'info'   :
                    'default'
                  }>
                    {assignment.territory_level === 'barrio'
                      ? '🏘 Barrio/Paraje'
                      : assignment.territory_level === 'seccion'
                      ? '📍 Sección'
                      : assignment.territory_level ?? 'Territorio'}
                  </Badge>
                  <Button
                    size="sm"
                    onClick={() =>
